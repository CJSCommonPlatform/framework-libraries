...
public class AllPluginsInstantiatorTest {
    ...
    public void shouldInstantiateAllTheListOfPluginNames() throws Exception {
        ...
        final Object plugin_1 = mock(ClassModifyingPlugin.class);
        final Object plugin_2 = mock(ClassModifyingPlugin.class);
        final Object plugin_3 = mock(ClassModifyingPlugin.class);
