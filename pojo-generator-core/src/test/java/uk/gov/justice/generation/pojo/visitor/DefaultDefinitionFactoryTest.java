...
public class DefaultDefinitionFactoryTest {
    ...
    public void shouldConstructClassDefinitionWithEventName() throws Exception {
        ...
        final DefaultDefinitionFactory definitionFactoryWithEventName = new DefaultDefinitionFactory(classNameProvider, eventName);
    ...
    public void shouldConstructClassDefinitionWithNoEventNameIfNoEventNameSet() throws Exception {
        ...
        final DefaultDefinitionFactory definitionFactoryWithNoEventName = new DefaultDefinitionFactory(classNameProvider);
    ...
    public void shouldConstructClassDefinition() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructDefinitionFor(fieldName, packageName, objectSchema);
    ...
    public void shouldConstructCombinedDefinition() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructDefinitionFor(fieldName, packageName, combinedSchema);
    ...
    public void shouldConstructFieldDefinitionForArraySchema() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructDefinitionFor(fieldName, packageName, arraySchema);
    ...
    public void shouldConstructEnumDefinition() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructDefinitionFor(fieldName, packageName, enumSchema);
    ...
    public void shouldConstructFieldDefinitionForStringSchemaWithDescriptionOfTheClassName() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructFieldDefinition(fieldName, stringSchema);
    ...
    public void shouldConstructFieldDefinitionForBooleanSchema() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructFieldDefinition(fieldName, booleanSchema);
    ...
    public void shouldConstructFieldDefinitionForNumberSchema() throws Exception {
        ...
        final Definition definition = new DefaultDefinitionFactory(classNameProvider).constructFieldDefinition(fieldName, numberSchema);
    ...
    public void shouldThrowExceptionIfUnknownSchemaProcessedForConstructDefintionWithEvent() throws Exception {
        ...
        new DefaultDefinitionFactory(classNameProvider).constructDefinitionWithEventFor(fieldName, packageName, dummySchema);
    }
    ...
    public void shouldThrowExceptionIfUnknownSchemaProcessedForConstructDefintion() throws Exception {
        ...
        final String packageName = "package.name";
        final DummySchema dummySchema = new DummySchema(builder, fieldName);
        new DefaultDefinitionFactory(classNameProvider).constructDefinitionFor(fieldName, packageName, dummySchema);
    }
    ...
    public void shouldThrowExceptionIfUnknownSchemaProcessedForConstructFieldDefintion() throws Exception {
        ...
        final String fieldName = "myDummy";
        final DummySchema dummySchema = new DummySchema(builder, fieldName);
        new DefaultDefinitionFactory(classNameProvider).constructFieldDefinition("fieldName", dummySchema);
    }
